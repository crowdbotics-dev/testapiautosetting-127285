...
## Project Structure
    ...
    ├── testapiautosetting_127285  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127285`
...
2. Clone this repo and `cd testapiautosetting_127285`
